...
namespace Bluelands\mc crates\crates;
...
class Crate
{
     ...
     */
    public function __construct(mc crates $plugin, string $name, string $floatingText, array $drops, int $dropCount, array $commands)
    {
        $this->plugin = $plugin;
        $this->name = $name;
